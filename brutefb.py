...
tytyd = str(raw_input("[!]tools ini hanya menebak data password yang ada  [!](Tekan Enter)"))
...
def main():
  ...
  hell()
  search()
  print("Wordlist Habis! silahkan tambahkan data password pada wordlist - DeathGuns")
